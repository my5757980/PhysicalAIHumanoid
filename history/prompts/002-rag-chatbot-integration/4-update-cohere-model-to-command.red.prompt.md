---
id: 4
title: "Update Cohere Model to Command"
stage: "red"
date_iso: "2025-12-12"
surface: "agent"
...
outcome: "Updated Cohere model from command-r to command"
evaluation: "Backend now uses supported Cohere model"
---

# Update Cohere Model to Command
...
←[32mINFO←[0m:     Started reloader process [←[36m←[1m7580←[0m] using ←[36m←[1mStatReload←[0m
...
←[32mINFO←[0m:     Started server process [←[36m11452←[0m]
...
←[32mINFO←[0m:     127.0.0.1:59867 - "←[1mOPTIONS /ask_stream HTTP/1.1←[0m" ←[32m200 OK←[0m
INFO:backend.main:Received streaming query: what is Physical AI & Humanoid Robotics
←[32mINFO←[0m:     127.0.0.1:59867 - "←[1mPOST /ask_stream HTTP/1.1←[0m" ←[32m200 OK←[0m
...
ERROR:backend.main:Cohere streaming error: headers: {'access-control-expose-headers': 'X-Debug-Trace-ID', 'cache-control': 'no-cache, no-store, no-transform, must-revalidate, private, max-age=0', 'content-encoding': 'gzip', 'content-type': 'application/json', 'expires': 'Thu, 01 Jan 1970 00:00:00 GMT', 'pragma': 'no-cache', 'vary': 'Origin,Accept-Encoding', 'x-accel-expires': '0', 'x-debug-trace-id': '9b33864659a07421f16babd3ed964c68', 'x-endpoint-monthly-call-limit': '1000', 'x-trial-endpoint-call-limit': '20', 'x-trial-endpoint-call-remaining': '19', 'date': 'Fri, 12 Dec 2025 10:47:31 GMT', 'x-envoy-upstream-service-time': '8', 'server': 'envoy', 'via': '1.1 google', 'alt-svc': 'h3=":443"; ma=2592000,h3-29=":443"; ma=2592000', 'transfer-encoding': 'chunked'}, status_code: 404, body: {'id': '4b2c6651-4837-44cb-a066-328389be9ad1', 'message': "model 'command-r' was removed on September 15, 2025. See https://docs.cohere.com/docs/models#command for a list of models you can use instead."}
```

## Response
Updated the Cohere model from the deprecated `command-r` to the `command` model in both streaming and non-streaming functions:

### Changed:
- Updated streaming function: `model="command-r"` to `model="command"`
- Updated non-streaming function: `model="command-r"` to `model="command"`
- The `command-r` model was also removed on September 15, 2025, so using `command` which should be a currently supported model